...
ros_pointcloud2::impl_pointcloud2_for_hiroz!();

#[test]
fn convertxyz_hiroz_msg() {
    ...
    let hiroz_msg_cloud: PointCloud2 = crate::impl_hiroz::from_pointcloud2_msg(internal_cloud);
    let convert_back_internal: PointCloud2Msg =
        crate::impl_hiroz::to_pointcloud2_msg(hiroz_msg_cloud);
