...
Get started with the example below or visit the [documentation](https://docs.rs/ros_pointcloud2/1.0.0-rc.5/ros_pointcloud2/) for a complete guide.
...
```toml
[dependencies]
ros_pointcloud2 = { version = "1.0.0-rc.5", features = ["rclrs"] } # or use the old version 0.6
```
